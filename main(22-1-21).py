...
def howToPlay():
    ...
    while running:
        ...
        display_text(15, "<-- Back to menu [escape]", colors['white'], 10, 10, False) 
...
def menu():
    ...
    while running:
        ...
        display_text(25, "How to play", color1, screenWidth/3, screenHeight/2, True)
        display_text(25, "Play", color2, screenWidth/3 + 300, screenHeight/2, True)
        
        if color1 == colors['white']:
            display_text(17, "press space", [200,200,200], screenWidth/3, screenHeight/2 + 35, True)
            player.x = screenWidth/3 - player.size[0]/2
        elif color2 == colors['white']:
            display_text(17, "press space", [200,200,200], screenWidth/3 + 300, screenHeight/2 + 35, True)
            player.x = screenWidth/3 - player.size[0]/2 + 300
